...
- **20/09/2024 h. 09:30, Room 4M**
  - remember to enroll at the exam, by *16/09/2024*, on the Portale della Didattica
  - all the assignments (including the code) must be on the group's GitHub repositories by *13/09/2024 EOD*

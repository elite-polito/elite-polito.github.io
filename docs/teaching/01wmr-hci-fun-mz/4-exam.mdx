...
- **xx/xx/2027 h. xx:00, Room xx**
  - remember to enroll at the exam, by *xx/xx/2027*, on the Portale della Didattica
  - all the assignments (including the code) must be on the group's GitHub repositories by *xx/xx/2027 EOD*
...
- Group composition
  ...
  - [Submit the form](https://forms.gle/VPhpeZboe9gRFFnU9)

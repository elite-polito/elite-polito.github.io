...
- **08/07/2024 h. 09:00, Room R2i**
  - remember to enroll at the exam, by *02/07/2024*, on the Portale della Didattica
  - all the assignments (including the code) must be on the group's GitHub repositories by *01/07/2024 EOD*

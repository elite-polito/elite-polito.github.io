...
<LectureRow
    ...
    >
    <><Link to="https://polito-iaw-2024.github.io/materiale/laboratori/lab-01-primi-passi-html-css.pdf" title="Lab 1: Primi passi con HTML e CSS">Primi passi con HTML e CSS</Link> (gruppo I)</>
</LectureRow>

<LectureRow
    date="06/03/2025" time="17:30-19:00" type="Lab" teacher="Tommaso Calò"
    >
    <><Link to="https://polito-iaw-2024.github.io/materiale/laboratori/lab-01-primi-passi-html-css.pdf" title="Lab 1: Primi passi con HTML e CSS">Primi passi con HTML e CSS</Link> (gruppo II)</>
</LectureRow>

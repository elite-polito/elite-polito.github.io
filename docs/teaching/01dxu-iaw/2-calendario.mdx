...
<LectureRow
    ...
    >
    <>Esercizi sugli aspetti avanzati di CSS3<ul><li><Link to="https://github.com/polito-iaw-2024/materiale/tree/main/esercizi/04-more-css/playground">Playground CSS Grid Layout & CSS Flexbox</Link> (su GitHub)</li></ul></>
</LectureRow>

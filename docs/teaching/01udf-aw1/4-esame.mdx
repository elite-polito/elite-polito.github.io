...
- [Istruzioni per GitHub Classroom](https://github.com/polito-webapp1/aw1-weeks-2026/blob/main/week12/github-classroom.md)

### Anno 2025/2026

- [Esame #1 - Ultima Corsa](https://docs.google.com/document/d/1rY4hN5GCjxgvEGIY86KIdUN2u8xmA2cjaMfxmSE9Nds) (scadenza: 2026-06-22 alle 23:59)
  - In caso di dubbi o domande, aggiungere un commento al documento linkato sopra - la versione finale sarà pubblicata il *2026-06-05*.
  - Chiarimenti aggiuntivi possono essere richiesti nel topic dedicato all'esame nel gruppo Telegram del corso.
  - Completate l'assignment su GitHub Classroom: [scheletro del progetto e invio dell'esame](https://classroom.github.com/a/iZes9Qfg).
  - L'esame si terrà dal *2026-06-23* in poi secondo il calendario concordato con gli iscritti all'appello tramite il gruppo Telegram.

- [Esame #2 - Battaglia Navale](https://docs.google.com/document/d/1I1HcfS6jUQniancir3C_QSYywF-FTzdYDWmU7SJzSM4) (scadenza: 2026-07-09 alle 23:59)
  - In caso di dubbi o domande, aggiungere un commento al documento linkato sopra - la versione finale sarà pubblicata il *2026-06-29*.
  - Chiarimenti aggiuntivi possono essere richiesti nel topic dedicato all'esame nel gruppo Telegram del corso.
  - Completate l'assignment su GitHub Classroom: [scheletro del progetto e sottomissione dell'esame](https://classroom.github.com/a/W4bhbCo5).
  - L'esame si terrà nella settimana del *2026-07-13* secondo il calendario concordato con gli iscritti all'appello tramite il gruppo Telegram.

  - [Esame #3 - Caccia al Tesoro](https://docs.google.com/document/d/1iBWgmxlZLSlWgeEiqFzWShBPIW9WmIyEL8hNqxtpmBc) (scadenza: 2026-09-09 alle 23:59)
  - In caso di dubbi o domande, aggiungere un commento al documento linkato sopra - la versione finale sarà pubblicata il *2026-08-27*.
  - Chiarimenti aggiuntivi possono essere richiesti nel topic dedicato all'esame nel gruppo Telegram del corso.
  - Completate l'assignment su Classroom50 dopo aver accettato l'invito via mail: [scheletro del progetto e sottomissione dell'esame](https://classroom50.org/polito-aw1-2026-exams/applicazioni-web-i-esami-e-lab-2025-2026/assignments/esame3-caccia-tesoro/accept).
  - L'esame si terrà dal giorno *2026-09-10* secondo il calendario concordato con gli iscritti all'appello tramite il gruppo Telegram.

### Anno 2024/2025

- [Esame #1 - Gioco della Sfortuna](https://docs.google.com/document/d/1M33wjx0DTgZSIBhdLQc1-jQdQ6znLe7BbjRz0w3FLe0)
- [Esame #2 - Compiti](https://docs.google.com/document/d/1tqCwij4Yjp5eP-5nhybneA1lqODxbGJ0TKV7ODoYPL8/)
- [Esame #3 - Indovina la Frase](https://docs.google.com/document/d/1y7LpM1HrxARrGrN2MOCr6RkOOKu1wSGsnADCWQgNcu8)
- [Esame #4 - Riepilogo Annuale](https://docs.google.com/document/d/1vEjr8p5fN2Dr-fWuOB4zPvOCQ-1P8_XmK3iFbOEev6g)
...
- Esame 4: [GridForm](https://docs.google.com/document/d/1vUwew3J3ZQGF-ndPB3aihsBKd1EI4jlzRC58pI8lkQ0)
- Esame 5: [Poke](https://docs.google.com/document/d/1e0Ev7gcY15EFsUkyRV5xYyxj5oSCW8TfNC7tt_q5uG8)

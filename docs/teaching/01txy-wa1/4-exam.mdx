...
<summary> Exam 2 (July 2026)</summary>
    ...
    <summary>What to do & **deadlines**</summary>
        ...
        - Book a date for the oral discussions (booking will open on 07/07 -- only for the students who completed the two steps above)
        - Submit the project on GitHub carefully following the instructions
    </details>

    <details> 
       <summary>Tentative Dates for Oral discussions</summary>

    The actual dates, and the number of slots, will be confirmed on the evening of 06/07, and will depend on the number of enrolled students.
    - 10/07 at 9:00
    - 10/07 at 13:00
    - 13/07 at 9:00
    - 14/07 at 14:00

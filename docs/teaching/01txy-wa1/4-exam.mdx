...
:::warning
The `GitHub Classroom` platform has been discontinued by GitHub. All future assignments will be handled through the `Classroom50` platform. The links to the assignments and a short guide will be published as soon as possible.
:::

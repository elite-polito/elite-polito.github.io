...
:::warning
The `GitHub Classroom` platform has been discotinued by GitHub. All future assignments will be handled through the `Classroom50` platform. The links to the assignments and a short guide will be published as soon as possible.
:::
...
<summary> Exam 2 (July 2026)</summary>
    - Exam text: **[Battleship](https://docs.google.com/document/d/1LwHVi9Jqzr9E-InVGzbGjlM7Lh50XGIeYDU-Oc1SPns/edit?usp=sharing)**
    - Deadline for submission: 09/07/2026 at 23:59
...
<summary> Exam 3 (September 2026)</summary>
    - Deadline for submission: 09/09/2026 at 23:59
    ...
    <summary>What to do & **deadlines**</summary>
        ...
        - **Accept** the project in the `Classroom50` platform (⚠️new⚠️) - by 04/09/2026 h. 14:00

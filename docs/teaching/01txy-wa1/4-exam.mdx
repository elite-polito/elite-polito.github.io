...
<details open>
    <summary>Exam 1 (June 2026) </summary>
        ...
        - You may ask questions or clarifications by adding comments on the above document until June 5
        - During the lab hours of June 5, the questions will be answered and the text will be finalized
    ...
    <summary>What to do & **deadlines**</summary>
        ...
        - Book a date for the oral discussions on the Moodle page of the course - will be open on June
        - Submit the project on GitHub following the instructions
    </details>
    <details>    
    <summary>Dates for oral discussions (tentative)</summary>
    ```
    08/06/2026 10.00.00
    15/06/2026 14.30.00
    16/06/2026 14.30.00

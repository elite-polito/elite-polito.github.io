...
- Exam 1: [Meme Game](https://docs.google.com/document/d/1NIgIrOY9G1A6uhqtunVdY7kZh72kjxcH4usWo7W6B9g/edit?usp=sharing)
    ...
    {/* - GitHub Classroom for this project: https://classroom.github.com/a/AVMm0VzU */}
- Exam 2: [Social Budget](https://docs.google.com/document/d/1ra3XJbrQGPNNEBl5doZbhtz5vgKp6p1ePJfd3SKNa20/edit?usp=sharing)
    ...
    {/* - You may enter comments on the exam text to ask for clarifications. */}
    {/* - The final version will be published on 2024-07-01 */}
    {/* - GitHub Classroom for this project: https://classroom.github.com/a/CNwikhrY */}
    {/* - Oral discussions: */}
        {/* - Discussions will take place in LAB 10 (at DAUIN 2nd floor - just above LABINF) - please wait in the room in front of the elevators for your turn. */}
        {/* - Book a slot here https://calendar.google.com/calendar/u/0/selfsched?sstoken=UUFIVF8weTZZR3VXfGRlZmF1bHR8ODM4MDhkYjhmYTU5MzNkZmIyZWYyOTg5NDBiZDEzNmE */}
- Exam 3: [Instant Lottery](https://docs.google.com/document/d/1j7lllVUZ-DYsJHIqF0OOPLLxhhNq3FxH8ip9pvWdqh0/edit?usp=sharing)
    ...
    {/* - You may enter comments on the exam text to ask for clarifications. */}
    {/* - The final version will be published on 2024-09-05 */}
...
- Exam 4: [Achievements](https://docs.google.com/document/d/17zTwDBEhYBvVSIKv3GeoPoY_-cWnwp-Kpy0KKrXAqDU/edit?usp=sharing)
    ...
    {/* - You may enter comments on the exam text to ask for clarifications. */}
    - [Comments and answers](https://drive.google.com/file/d/1tH3LdTZEHYGDYhubp31tpVGjhVyk1yop/view?usp=sharing) on the preliminary versions (just for reference)
    {/* - The final version will be published on 2025-01-08 */}
    - GitHub Classroom for this project: https://classroom.github.com/a/L6J_jFK7

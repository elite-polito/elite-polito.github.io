...
Le soluzioni sono state presentate nella [Lezione L31](https://youtu.be/GPvzF1OlFX0)
...
<details>
<summary>Una possibile soluzione</summary>
```python
citta = ["Torino", "Milano", "Roma", "Napoli", "Palermo"]
temperature = [15, 18, 22, 24, 26]
...
- Si ricorda che sono disponibili [tutte le domande d'esame degli anni precedenti](https://github.com/polito-informatica/Esempi-esame?tab=readme-ov-file#readme)

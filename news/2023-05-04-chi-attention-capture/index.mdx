...
<p className="text--center"><img src={fakesocial} alt="Fake Social Notification on LinkedIn" width="30%"></img></p>
...
<p className="text--center"><img src={autoplay} alt="Neverending Autoplay on YouTube" width="80%"></img></p>
...
<p className="text--center"><img src={playing} alt="Playing by Appointment on Snapchat" width="30%"></img></p>

...
<p className="text--center"><img src={screentime} alt="Screen Time app on iPhones" width="60%"></img></p>
...
<p className="text--center"><img src={functionality} alt="A chart showing the different functionality of contemporary DSCTs." width="90%"></img></p>
...
<p className="text--center"><img src={forest} alt="Forest plot highlighting positive effect size on reducing time spent of contemporary DSCTs." width="50%"></img></p>
